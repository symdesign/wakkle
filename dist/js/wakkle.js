...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return pref; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return device_orientation_drag; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_collector__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_UI__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_sound__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_markup__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_minimap__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_fullscreen__ = __webpack_require__(23);
...
var init = function (options) {
    ...
    for (var i = 0; i < wakkles.length; i++) {
        ...
        ui[i] = new __WEBPACK_IMPORTED_MODULE_3__components_UI__["a" /* UI */](wakkle);
        ui[i].init();
        ...
        minimap[i] = new __WEBPACK_IMPORTED_MODULE_9__components_minimap__["a" /* Minimap */](wakkle);
        minimap[i].init();
        controller[i].connect(minimap[i]);

        fullscreen[i] = new __WEBPACK_IMPORTED_MODULE_10__components_fullscreen__["a" /* Fullscreen */](wakkle);
        fullscreen[i].init();
    }
...
var Controller = function (wakkle) {
    ...
    this.init = function () {
        ...
        if (UI && hasWebcam()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["d" /* head_move */]);
        }
        if (UI && hasMouse()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["g" /* mouse_move */]);
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["f" /* mouse_drag */]);
        }
        if (UI && hasTouch()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["i" /* touch_drag */]);
        }
        if (UI && hasDeviceOrientation()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["b" /* device_orientation */]);
        }
        if (UI && hasDeviceOrientation()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__UI__["c" /* device_orientation_drag */]);
        }
    ...
    this.icons = __WEBPACK_IMPORTED_MODULE_0__UI__["e" /* icons */];
    ...
    this.UI = {
        ...
        init: function () {
            ...
            for (var i = 0; i < trackers.length; i++) {
                ...
                li.className = __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'controller-button ' + tracker.name;
                li.style.width = '2em';
                li.style.height = '2em';
                ...
                ul.className = __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'controller-buttons ';
                ul.appendChild(li);
            }
        ...
        set: function (tracker) {
            ...
            var controllerButtons = wakkle.ui.wrapper.querySelectorAll('.' + __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'controller-button');
    ...
    if (hasWebcam()) {
        Object(__WEBPACK_IMPORTED_MODULE_1__controller_loadScript_js__["a" /* loadScript */])(__WEBPACK_IMPORTED_MODULE_0__UI__["d" /* head_move */].lib, initHeadtrackr);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_vendorPrefix__ = __webpack_require__(18);
...
var Mask = function (wakkle) {
    ...
    this.init = function () {
        ...
        console.log(__WEBPACK_IMPORTED_MODULE_2__utils_vendorPrefix__["a" /* prefix */]);
    ...
    this.update = function () {
        ...
        for (var i = 0; i < masked.length; i++) {
            masked[i].style[__WEBPACK_IMPORTED_MODULE_2__utils_vendorPrefix__["a" /* prefix */].clipPath] = 'url(#' + masked[i].id + '--' + Object(__WEBPACK_IMPORTED_MODULE_1__collector_numberPadding__["a" /* pad */])(Math.round((wakkle.sequence.length - 1) * that.q), wakkle.sequence.padding) + ')';
        }
    };
};
...
var Sound = function (wakkle) {
    ...
    this.UI = {
        init: function () {
            ...
            soundButton.className = __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'sound-button ';
        ...
        set: function (playing) {
            var soundButton = wakkle.wrapper.querySelector('.' + __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'sound-button use');
...
var Minimap = function (wakkle) {
    ...
    this.init = function () {
        ...
        minimap.className = __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'minimap ';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UI__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_screenfull__ = __webpack_require__(24);
...
var Fullscreen = function (wakkle) {
    ...
    this.init = function () {
        ...
        fullscreenButton.className = __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'fullscreen-button ';
    ...
    this.toggleUI = function () {
        ...
        var fullscreenButton = wakkle.wrapper.querySelector('.' + __WEBPACK_IMPORTED_MODULE_0__UI__["h" /* pref */] + 'fullscreen-button');
