...
/******/ 	var hotCurrentHash = "7258b91f5ff50055c60a"; // eslint-disable-line no-unused-vars
...
var icons = {
    ...
    init: function () {
        var wrapper = document.createElement('div'),
            svg = __webpack_require__("./src/js/components/UI/icons.svg");
...
var Collector = function () {
    ...
    var regexp = new RegExp('.*?\.' + __WEBPACK_IMPORTED_MODULE_0__const__["c" /* file_extension */], 'i');
    ...
    this.init = function () {
        ...
        for (var i = 0; i < imgs.length; i++) {
            ...
            loadJSON(path + 'meta.json', function (json) {
                img.sound.Source = path + json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].Sound || '';
                img.meta = {
                    "FOV": json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].FOV,
                    "Phi": json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].Phi,
                    "Chi": json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].Chi,
                    "OriginX": json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].OriginX,
                    "OriginY": json[__WEBPACK_IMPORTED_MODULE_0__const__["e" /* meta_key */]].OriginY
                };
            });
            ...
            document.registerElement(__WEBPACK_IMPORTED_MODULE_0__const__["h" /* tagname */]);

            img.wrapper = img.parentElement.nodeName.toLowerCase() == __WEBPACK_IMPORTED_MODULE_0__const__["h" /* tagname */] ? img.parentElement : wrap(img);
...
function getSequence(path) {
    ...
    function findLength() {
        ...
        for (var i = 0; i <= maxLength; i++) {
            ...
            var testImage = Object(__WEBPACK_IMPORTED_MODULE_2__collector_numberPadding__["a" /* pad */])(i, sequence.padding) + '.' + sequence.extension;
            xhr = new XMLHttpRequest();
...
/***/ "./src/js/components/collector/numberPadding.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/js/components/const.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return file_extension; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return tagname; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return class_prefix; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return meta_key; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return head_move; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return mouse_move; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return mouse_drag; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return touch_drag; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return device_orientation; });

var file_extension = 'wakkle'; // your-image.wakkle
var tagname = 'wakkle-image'; // <wakkle-image> Note: the tagname needs to contain a dash
var class_prefix = 'wakkle-'; // .wakkle-sound-button, etc.
var meta_key = 'WAKKLE-dataset';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__const__ = __webpack_require__("./src/js/components/const.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UI_icons__ = __webpack_require__("./src/js/components/UI/icons.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__controller_loadScript_js__ = __webpack_require__("./src/js/components/controller/loadScript.js");
...
var Controller = function (element) {
    ...
    this.init = function () {
        ...
        if (UI && hasWebcam()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__const__["d" /* head_move */]);
        }
        if (UI && hasMouse()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__const__["g" /* mouse_move */]);
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__const__["f" /* mouse_drag */]);
        }
        if (UI && hasTouch()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__const__["i" /* touch_drag */]);
        }
        if (UI && hasDeviceOrientation()) {
            trackers.push(__WEBPACK_IMPORTED_MODULE_0__const__["b" /* device_orientation */]);
        }
    ...
    this.icons = __WEBPACK_IMPORTED_MODULE_1__UI_icons__["a" /* icons */];
    ...
    this.UI = {
        ...
        init: function () {
            ...
            for (var i = 0; i < trackers.length; i++) {
                ...
                li.className = __WEBPACK_IMPORTED_MODULE_0__const__["a" /* class_prefix */] + 'controller-button ' + tracker.name;
                li.style.width = '2em';
                li.style.height = '2em';
    ...
    if (hasWebcam()) {
        Object(__WEBPACK_IMPORTED_MODULE_2__controller_loadScript_js__["a" /* loadScript */])(__WEBPACK_IMPORTED_MODULE_0__const__["d" /* head_move */].lib, initHeadtrackr);
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UI_icons__ = __webpack_require__("./src/js/components/UI/icons.js");
...
var Fullscreen = function (element) {
    ...
    this.icons = __WEBPACK_IMPORTED_MODULE_2__UI_icons__["a" /* icons */];

    this.init = function () {

        if (!element.ui.fullscreen || !__WEBPACK_IMPORTED_MODULE_1_screenfull__["enabled"]) return;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__collector_numberPadding__ = __webpack_require__("./src/js/components/collector/numberPadding.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__image_removeFromArray__ = __webpack_require__("./src/js/components/image/removeFromArray.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__image_sortArrayMiddleToOut__ = __webpack_require__("./src/js/components/image/sortArrayMiddleToOut.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__image_imagePreload__ = __webpack_require__("./src/js/components/image/imagePreload.js");
...
var Sequence = function (element) {
    ...
    function loadImages() {
        ...
        var images = Object(__WEBPACK_IMPORTED_MODULE_2__image_sortArrayMiddleToOut__["a" /* sortArrayMiddleToOut */])(element.sequence.images),
            ...
            onProgress: function (image, imageEl, index) {
                ...
                for (var i = 0; i < loaded.length; i++) {
                    ...
                    if (loaded.indexOf(element.sequence.images[b]) >= 0) {
                        Object(__WEBPACK_IMPORTED_MODULE_1__image_removeFromArray__["a" /* removeFromArray */])(loaded, element.sequence.images[b]);
                    ...
                    if (loaded.indexOf(element.sequence.images[a]) >= 0) {
                        Object(__WEBPACK_IMPORTED_MODULE_1__image_removeFromArray__["a" /* removeFromArray */])(loaded, element.sequence.images[a]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_simple_element_resize_detector__ = __webpack_require__("./node_modules/simple-element-resize-detector/dist/simple-element-resize-detector.js");
    ...
    function convertAttributes(object) {
        ...
        for (var j = 0; j < object.children.length; j++) {
            ...
            var q = document.createElement('div'),
                // = where the controller is applied to
            ...
            xyz.style.transform = ' translateX(' + -1 * (parseInt(position.x) + origin.x) + '%)' + ' translateY(' + -1 * (parseInt(position.y) + origin.y) + '%)' + ' translateZ(' + -1 * (position.z / 100 * element.width) + 'px)' + ' rotateX(' + rotation.x + 'deg)' + ' rotateY(' + rotation.y + 'deg)' + ' rotateZ(' + rotation.z + 'deg)';
...
var Sound = function (element) {
    ...
    this.init = function () {
        ...
        setTimeout(function () {
            if (audio.currentTime == 0) _this.pause();
            _this.UI.init();
        }, 1000);
    };
